...
private:
    ...
    // ————— AI STATE ————— //
    int m_ai_patrol_ticks;
    bool m_switch_patrol_left;
    bool looking_right;
...
public:
    ...
    void ai_activate(Entity* player, int ticks, Entity* bullet = nullptr, bool attack_up=false, float rotate_weapon=0.0f);
    void ai_walk();
    void ai_guard(Entity* player);
    void ai_patrol(int ticks, Entity* bullet = nullptr, bool attack_up=false, float rotate_weapon=0.0f);
    ...
    void const set_texture_flip(bool new_flip) { m_flip_texture = new_flip; }
